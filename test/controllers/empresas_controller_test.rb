...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post empresas_url, params: { empresa: { cep: @empresa.cep, cnpj: @empresa.cnpj, nome: @empresa.nome, numero: @empresa.numero } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { cep: @empresa.cep, cnpj: @empresa.cnpj, nome: @empresa.nome, numero: @empresa.numero } }
